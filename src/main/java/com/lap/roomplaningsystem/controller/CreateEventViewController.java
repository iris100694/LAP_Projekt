...
public class CreateEventViewController extends BaseController{
    ...
    public void executeSingle() throws Exception {
        ...
        if(DateValidator.oneTime(singleDatePicker.getValue())){
            if(eventValidator.validSingle(roomComboBox.getValue(),courseComboBox.getValue(), singleDatePicker.getValue(), singleStartTimeComboBox.getValue(), singleEndTimeComboBox.getValue())){
    ...
    private EventValidator handleDates(String serie) {
        ...
        boolean validEvents = switch (serie){
            case "täglich" -> eventValidator.validSeries(roomComboBox.getValue(), courseComboBox.getValue(), DateValidator.daily(seriesStartDatePicker.getValue(), seriesEndDatePicker.getValue()),seriesStartTimeComboBox.getValue(), seriesEndTimeComboBox.getValue());
            case "wöchentlich" -> eventValidator.validSeries(roomComboBox.getValue(), courseComboBox.getValue(), DateValidator.weekly(seriesStartDatePicker.getValue(), seriesEndDatePicker.getValue()),seriesStartTimeComboBox.getValue(), seriesEndTimeComboBox.getValue());
            case "monatlich" -> eventValidator.validSeries(roomComboBox.getValue(), courseComboBox.getValue(), DateValidator.monthly(seriesStartDatePicker.getValue(), seriesEndDatePicker.getValue()),seriesStartTimeComboBox.getValue(), seriesEndTimeComboBox.getValue());
            default -> false;
        };
